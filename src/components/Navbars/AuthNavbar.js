        ...
        <div className='container mx-auto flex flex-wrap items-center justify-between px-4'>
          ...
          >
            ...
            <ul className='flex list-none flex-col lg:ml-auto lg:flex-row'>
              ...
              <li className='flex items-center'>
                <button
                  className='ml-3 mb-3 rounded bg-white px-4 py-2 text-xs font-bold uppercase text-blueGray-700 shadow outline-none transition-all duration-150 ease-linear hover:shadow-md focus:outline-none active:bg-blueGray-50 lg:mr-1 lg:mb-0'
                  type='button'
                >
