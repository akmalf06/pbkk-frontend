        ...
        <div className='mx-autp flex w-full flex-wrap items-center justify-between px-4 md:flex-nowrap md:px-10'>
          ...
          <form className='mr-3 hidden flex-row flex-wrap items-center md:flex lg:ml-auto'>
            <div className='relative flex w-full flex-wrap items-stretch'>
              <span className='absolute absolute z-10 h-full w-8 items-center justify-center rounded bg-transparent py-3 pl-3 text-center text-base font-normal leading-snug text-blueGray-300'>
                <i className='fas fa-search'></i>
              </span>
              <input
                type='text'
                placeholder='Search here...'
                className='relative w-full rounded border-0 bg-white bg-white px-3 py-3 pl-10 text-sm text-blueGray-600 placeholder-blueGray-300 shadow outline-none focus:outline-none focus:ring'
              />
            </div>
          </form>
          {/* User */}
