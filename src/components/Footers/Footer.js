          ...
          <div className='flex flex-wrap text-center lg:text-left'>
            <div className='w-full px-4 lg:w-6/12'>
              ...
              <div className='mt-6 mb-6 lg:mb-0'>
                <button
                  className='align-center mr-2 h-10 w-10 items-center justify-center rounded-full bg-white font-normal text-lightBlue-400 shadow-lg outline-none focus:outline-none'
                  type='button'
                >
                  <i className='fab fa-twitter'></i>
                </button>
                <button
                  className='align-center mr-2 h-10 w-10 items-center justify-center rounded-full bg-white font-normal text-lightBlue-600 shadow-lg outline-none focus:outline-none'
                  type='button'
                >
